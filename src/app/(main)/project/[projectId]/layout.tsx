    ...
    <div className="h-screen overflow-hidden">
      ...
      <div className="md:pl-[300px]">
        ...
        <div className="relative">
          <div
            className="h-full scrollbar backdrop-blur-[35px] dark:bg-muted/40 bg-muted/60 dark:shadow-2xl dark:shadow-black mx-auto pt-16 p-4 absolute top-0 right-0 left-0 bottom-0 z-[11]"
          >
            {children}
          </div>
        </div>
